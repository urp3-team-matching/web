  ...
  return (
    <div className="w-full h-[152px] shadow-md rounded-lg p-1">
      ...
      <div className="w-full h-4 rounded-2xl relative justify-between ">
        <div className="w-1/4 left-0  absolute z-40 h-full bg-amber-500 rounded-2xl"></div>
        <div className="w-1/2 left-0 absolute z-30 h-full bg-blue-400 rounded-2xl"></div>
        <div className="w-3/4 left-0 absolute z-20 h-full bg-emerald-400 rounded-2xl"></div>
        <div className="w-full h-full z-10 bg-red-500 rounded-2xl"></div>
